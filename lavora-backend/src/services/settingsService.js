...
const DEFAULTS = {
  ...
  services: [
    ...
    { name: 'Medical Skin Care',      department: 'beauty',     priceOMR: 50  },
    { name: 'Dermatology',            department: 'beauty',     priceOMR: 50  },
    { name: 'Consultation',           department: 'beauty',     priceOMR: 20  },
    { name: 'Laser Hair Removal',     department: 'laser',      priceOMR: 80  },
    { name: 'Onda Plus',              department: 'slimming',   priceOMR: 180 },
    { name: 'Redustim',               department: 'slimming',   priceOMR: 100 },
    { name: 'Body Wraps',             department: 'slimming',   priceOMR: 60  },
    { name: 'Aesthetic Gynecology',   department: 'gynecology', priceOMR: 200 },
